            ...
            ?>
                <form action="../code.php" method="post">
                    <ul>
                        ...
                        <input type="text" name="fullname" id="" placeholder="Enter your fullname"></li>
						...
						<input type="submit" class="clickSignUp" name="signup" Value="Sign Up">
						</li>
						<br>
						<li style="font-weight: 700; font-size:1.2rem !important; text-align:center;"> Already have an account? <span> <a href="sign-in.php" style="color: #2424ce; cursor: pointer; text-decoration:none;">Sign In</a> </span> </li>
                    </ul>
                </form>
            </div>
        </div>
